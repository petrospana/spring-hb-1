...
@Entity
@Table(name = "diefthintes")
public class Diefthintes {
    ...
    public Diefthintes(String username, String first_name, String last_name, String email, String password, int stathmos_id) {
        super();
